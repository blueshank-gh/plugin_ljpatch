...
local function setup(params)
    workspace("plugin_ljpatch" .. params.bitness .. params.prefix)
        ...
        project("plugin_ljpatch" .. params.bitness .. params.prefix)
            kind "SharedLib"
            language "C++"
            cppdialect "C++20"

            project().serverside = params.serverside
            ...
            local sdk = "sdk" .. params.bitness
            files { "entry_point.cpp", "luajit/src/**.h", "glua/**.h", sdk .. "/**.hpp", sdk .. "/**.h", sdk .. "/**.lib" }
            ...
            targetname ("plugin_ljpatch" .. params.bitness .. params.prefix)
